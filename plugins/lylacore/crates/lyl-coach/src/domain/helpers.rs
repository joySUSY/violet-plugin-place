...
static RE_PLEASE: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bplease\b").unwrap());
static RE_KINDLY: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bkindly\b").unwrap());
static RE_HEY: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bhey\b").unwrap());
static RE_YEAH: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\byeah\b").unwrap());
static RE_GONNA: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bgonna\b").unwrap());
