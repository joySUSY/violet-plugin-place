...
use lyl_cipher::{decrypt, encrypt, generate_salt, Key, KeyDerivationAlgorithm};
...
fn test_salt_clone_independence() {
    ...
    let salt2 = lyl_cipher::Salt::from_slice(bytes.as_slice()).expect("Failed to create salt");
